  ...
  return (
    <div className="flex flex-col">
        ...
        >
          {(field) => (
            <div className="flex flex-col gap-2">
              ...
              />
              <div
                className={`grid transition-[grid-template-rows] duration-200 ${field.state.meta.errors.length > 0 ? "grid-rows-[1fr]" : "grid-rows-[0fr]"}`}
              >
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        <button
          type="button"
          className="flex items-center justify-center py-4 border-2 border-gray-100 rounded-xl hover:border-gray-200 hover:bg-gray-50 transition-all shadow-sm cursor-pointer"
        >
      ...
      <div className="text-center text-[14px] font-medium text-gray-500">
        <p>
          {t("hasAccount")}{" "}
          <Link href="/login" className="text-[#FF5722] hover:underline font-bold">
            {t("signIn")}
          </Link>
        </p>
      </div>
