import { BookOpen, ChevronLeft, ChevronRight, ExternalLink, Globe, Play } from "lucide-react";
...
function StatusDot({ rating }: { rating: "strong" | "adequate" | "weak" }) {
  if (rating === "strong") {
    return (
      <span className="relative flex h-5 w-5 shrink-0">
        <span
          className="absolute inset-0 rounded-full bg-[conic-gradient(from_0deg,#f87171,#facc15,#4ade80,#60a5fa,#a78bfa,#f472b6,#f87171)] animate-spin"
  ...
  if (rating === "adequate") {
    return (
      <span className="h-5 w-5 shrink-0 rounded-full bg-amber-400 border-2 border-amber-300" />
    );
  }
      ...
      <main className="flex-1 mt-32 max-w-[90rem] mx-auto w-full px-6 md:px-10 pb-20">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col items-center gap-1.5">
              <div
                className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border text-xs font-bold ${source.className}`}
              >
                {source.icon}
                {source.label}
              </div>
              {verdictInfo ? (
                <div
                  className={`flex items-center px-3 py-1 rounded-full border text-xs font-semibold ${verdictInfo.className}`}
                >
                  {verdictInfo.label}
                </div>
              ) : null}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <section className="bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 shadow-sm border border-white/80">
            ...
            <p className="text-[#111827]/70 text-base leading-relaxed">
              This resource provides a comprehensive overview of the subject matter, detailing the
              fundamental principles and their practical applications. It is particularly suited for
              educators looking to integrate modern methodologies into their curriculum design while
          ...
          <section className="bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 shadow-sm border border-white/80">
            ...
            <p className="text-[#111827]/70 text-base leading-relaxed">
              The resource was evaluated for its direct applicability to classroom contexts. Its
              structure supports scaffolded learning, and the content density is appropriate for the
              target year level. The pedagogical approach aligns with inquiry-based learning
              frameworks widely adopted in current curriculum standards.
            </p>
          </section>
        </div>
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-slate-500 mt-1 leading-relaxed">
                  Highly aligned with standard curriculum benchmarks. The resource directly
                  addresses syllabus outcomes and supports competency-based learning objectives.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-slate-500 mt-1 leading-relaxed">
                  Adequate for most learners. Some sections may require pre-teaching of vocabulary
                  for EAL/D students. Built-in differentiation supports mixed-ability cohorts.
                </p>
              </div>
            </div>
            <div className="border-t border-slate-100" />
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-slate-500 mt-1 leading-relaxed">
                  Published by a reputable educational institution with peer-reviewed methodology.
                  No factual errors or bias detected during evaluation.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <section className="bg-rose-50 rounded-[2rem] p-8 border border-rose-100">
            ...
            <ul className="list-disc pl-5 text-rose-900 space-y-2.5 text-base">
              ...
              <li>
                Some examples included are culturally specific and may lack international relevance
              </li>
            </ul>
          </section>
        </div>
        ...
        <section className="bg-[#111827] text-white rounded-[2rem] p-8 shadow-md mb-6">
          ...
          <p className="text-white/90 text-base leading-relaxed">
            Consider pre-teaching core vocabulary before introducing this resource to the class. For
            international classrooms, it is strictly recommended to supplement the culturally
            specific examples with local equivalents to ensure relatability and context retention
            among students.
          </p>
        </section>
          ...
          <section className="lg:col-span-2 bg-amber-50/60 backdrop-blur-xl rounded-[2rem] p-8 shadow-sm border border-amber-100">
            ...
            <div className="bg-white/80 rounded-xl p-4 border border-amber-100 space-y-3">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Each resource is assessed against three core dimensions derived from educational
                best practice and your preset context.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-2.5 py-1 bg-white rounded-full text-[11px] font-semibold text-slate-600 border border-slate-200">
                  Curriculum Fit
                </span>
                <span className="px-2.5 py-1 bg-white rounded-full text-[11px] font-semibold text-slate-600 border border-slate-200">
                  Accessibility
            ...
            <div className="mt-5 pt-4 border-t border-amber-100">
              <p className="text-xs text-slate-400 leading-relaxed">
                Quotes are extracted verbatim from the source material, then cross-referenced
                against your classroom preset. No content is paraphrased or generated.
              </p>
            </div>
          </section>
          ...
          <section className="lg:col-span-3 bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 shadow-sm border border-white/80">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 bg-emerald-50 border border-emerald-200 rounded-full text-[11px] font-bold text-emerald-700 uppercase">
                    Curriculum Fit
                  </span>
                ...
                <blockquote className="border-l-4 border-[#111827] pl-5 italic text-gray-800 text-base leading-relaxed font-serif">
                  "The integration of context-aware examples improves student retention by up to 40%
                  in secondary education settings."
                </blockquote>
                <p className="text-sm text-slate-500 leading-relaxed pl-5">
                  This quote directly supports curriculum alignment because it demonstrates
                  evidence-backed pedagogy relevant to your Year level and subject context.
                </p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 bg-amber-50 border border-amber-200 rounded-full text-[11px] font-bold text-amber-700 uppercase">
                    Accessibility
                  </span>
                  <span className="text-[11px] text-slate-400 font-medium">Adequate</span>
                </div>
                <blockquote className="border-l-4 border-[#111827] pl-5 italic text-gray-800 text-base leading-relaxed font-serif">
                  "Educators found that utilizing dynamic assessments allowed for natural
                  differentiation among mixed-ability cohorts."
                </blockquote>
                <p className="text-sm text-slate-500 leading-relaxed pl-5">
                  Extracted because it indicates built-in differentiation support, critical for your
                  class profile.
                </p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 bg-[#B7FF70]/40 border border-[#B7FF70] rounded-full text-[11px] font-bold text-emerald-900 uppercase">
                    Curriculum Link
                  </span>
                </div>
                <blockquote className="border-l-4 border-[#B7FF70] pl-5 italic text-gray-800 text-base leading-relaxed font-serif">
                  "Addresses syllabus outcome: ENG-7-03 — Evaluates meaning and structure of
                  informational texts."
                </blockquote>
                <p className="text-sm text-slate-500 leading-relaxed pl-5">
                  A direct syllabus reference to verify this resource maps to a specific curriculum
                  outcome.
                </p>
              </div>
            </div>
