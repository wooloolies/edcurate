...
| api-contract | `.agents/rules/api-contract.md` | on request |
...
| design-direction-guide | `.agents/rules/design-direction-guide.md` | on request |
...
| no-cookies | `.agents/rules/no-cookies.md` | on request |
